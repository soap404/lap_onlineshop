...
<div class="email-container">
    <div class="email-header">
        <h1>Bestellstornierung durch unser Team</h1>
    </div>
    <div class="email-body">
        <h2>Hallo <?php echo htmlspecialchars($mail_user['fname']) . ' ' . htmlspecialchars($mail_user['lname']) ?>,</h2>
        <p>Ihre Bestellung wurde von unserem Team storniert. Hier sind die Details der stornierten Bestellung:</p>
        ...
        <p>Falls Sie Fragen haben oder eine neue Bestellung aufgeben möchten, kontaktieren Sie bitte unseren Kundenservice.</p>
    </div>
